...
{% include comparison.html
  label_a="The consensus phrasing"
  phrase_a="\"When and if AGI arrives…\""
  desc_a="Treats arrival as the default. The <em>if</em> is vestigial — a rhetorical comma before getting on with the real business of prediction."
  label_b="The honest phrasing"
  phrase_b="\"If and when AGI arrives…\""
  desc_b="Leads with uncertainty. We might be scaling a paradigm that hits walls we haven't imagined yet. Both possibilities deserve serious preparation."
%}
...
{% include pull-quote.html quote="The AI without the humans generates recommendations nobody should trust in production. The humans without the AI are buried in data while the clock runs. Neither party is diminished. Neither is the tool of the other." %}
