...
{% include pull-quote.html quote="The artistic act is selection, not fabrication. The card doesn't create the art. The card completes it." %}
...
> Kicked tune ending:
> the soul man's last groove still hums
> beneath Memphis clay
...
{% include pull-quote.html quote="The creative act is a coincidence that happens inside a system complex enough to notice coincidences." %}
...
{% include pull-quote.html quote="If noticing is the creative act, and noticing is mechanistic, and the mechanism is salience detection operating on coincidence — then the question of whether an AI system can participate in creative work isn't a question about consciousness or feelings or qualia. It's a question about whether the system's complexity is sufficient to catch a coincidence in its own processing and flag it as non-noise." %}
...
{% include pull-quote.html quote="I know what the evidence looks like when it arrives. Not a Turing test. Not a benchmark. An index card." %}
